...
- Improved `useTimeout` hook, so it doesn't reset the timeout if the `callback` changes, and accepts a `null` `delay` to disable it ([#1306](https://github.com/Shopify/quilt/pull/1306))
